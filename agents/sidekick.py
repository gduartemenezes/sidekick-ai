...
class Sidekick:
    ...
    def evaluator(self, state: State) -> State:
        ...
        new_state = {
            ...
            "feedback_on_work": evaluator_result.feedback,
            "success_criteria_met": evaluator_result.success_criteria_met,
            "user_input_needed": evaluator_result.user_input_needed,
        }
    ...
    async def run_superstep(self, message, success_criteria, history):
        ...
        result = self.graph.ainvoke(state, config=config)
